...
Tile_type("Art/Cute_wall_bubble_2", True, "x", animation=True, frame_delay = 6)
...
Tile_type("Art/Cute_plate_pride_bet_green.png", False, 'F')
Tile_type("Art/Cute_wall_bubble_3", True, "g", animation=True, frame_delay = 6)
Tile_type("Art/Cute_wall_bubble_4", True, "G", animation=True, frame_delay = 6)

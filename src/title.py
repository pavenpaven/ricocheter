...
def get_title_menu(change_state):
    ...
    a.set_font(CREDIT_FONT, 50, (0,0,0), (215, 190, 105), (0,0,0), (83, 68, 21), None, antialias=False )
    b.set_font(CREDIT_FONT, 50, (0,0,0), (215, 190, 105), (0,0,0), (83, 68, 21), None, antialias=False )
    return menu
